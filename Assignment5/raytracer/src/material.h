...
public:
    PhongMaterial(const Vec3f &_diffuseColor = Vec3f(0.0, 0.0, 0.0),
                  const Vec3f &_specularColor = Vec3f(0.0, 0.0, 0.0),
                  float _exponent = 0,
                  const Vec3f &_reflectiveColor = Vec3f(0.0, 0.0, 0.0),
                  const Vec3f &_transparentColor = Vec3f(0.0, 0.0, 0.0),
                  float _indexOfRefraction = 1) :
